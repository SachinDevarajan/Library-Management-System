...
class Library:
    ...
    def add_book(self):
        ...
        try:
            ...
            print("Invalid input, quantity and shelf ID must be numbers :", e)
            return
        ...
        try:
            ...
            print("Error fetching shelf location :", e)
            return
        ...
        if quantity > capacity:
            print("Quantity exceeds available shelf capacity")
            print(f"Available Capacity : {capacity}")
            return
        ...
        try:
            ...
            # Reduce the shelf's remaining capacity by the quantity just stored
            new_capacity = capacity - quantity
            cursor.execute('update shelf set capacity = %s where shelf_id = %s',(new_capacity, shelf_id))

            connection.commit()
            print("Book Added Successfully")
            print(f"Remaining Shelf Capacity : {new_capacity}")
        except Exception as e:
            connection.rollback()
